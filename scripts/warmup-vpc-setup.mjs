...
const WARMUP_PAYLOADS = {
  ...
  listDoctors: { httpMethod: 'GET', path: '/doctors', headers: {} },
  ...
  getDoctor: { httpMethod: 'GET', pathParameters: { id: 'warmup-id' } },
  ...
  createDoctor: { httpMethod: 'POST', body: JSON.stringify({ name: 'warmup' }) },
  createAppointment: { httpMethod: 'POST', body: JSON.stringify({ boxId: 'w', doctorId: 'w' }) },
  // Updates - payload mínimo
  updateBox: { httpMethod: 'PUT', pathParameters: { id: 'warmup' }, body: JSON.stringify({}) },
  updateDoctor: { httpMethod: 'PUT', pathParameters: { id: 'warmup' }, body: JSON.stringify({}) },
  ...
  deleteDoctor: { httpMethod: 'DELETE', pathParameters: { id: 'warmup' } },
