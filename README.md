# 🥊 SmartBoxing - Sistema de Gestión Médica

Sistema SaaS multi-tenant para gestión de consultas médicas, boxes y profesionales.
...
# Backend (local con serverless-offline)
npm run dev:backend
```
...
2. Configurar variables de entorno de AWS
3. Ejecutar deploy
...
- ✅ **Gestión de Boxes** (consultas médicas)
